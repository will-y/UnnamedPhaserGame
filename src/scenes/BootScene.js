...
class BootScene extends Scene {
    ...
    preload() {
        ...
        ItemRegistry.register(new ProjectileWeapon("gun", "primary", 20, 200, "projectile-basic", 0.5, false, 0, false));
        ItemRegistry.register(new LaserProjectileWeapon("laser_gun", "primary", 10, 250, "laser", 1.25, false, 0, false, false));
    }
